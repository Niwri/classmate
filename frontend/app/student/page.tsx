        ...
        <div className="h-screen flex flex-col">
            ...
            <section className="flex flex-col justify-start mx-32 md:mx-48 lg:mx-64 grow my-16">
                <section className="flex flex-row my-8 gap-x-16 justify-between">
                    <StatBox title="To-Do" value={5} progress={36} subtitle={"Questions Left"} size={2}/>
                    <StatBox title="Questions Completed" value={11} progress={62} subtitle={"Daily Goal"} size={2}/>
                    <StatBox title="Incorrect Answers" value={3} progress={64} subtitle={"Incorrect Responses"} size={2}/>
                </section>
